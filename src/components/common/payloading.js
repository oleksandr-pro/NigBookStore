...
class PayModalProgress extends Component {
  render() {
    return (
      <Modal
        transparent={true}
      ...
      >
        ...
        <View style ={{position:'absolute', top:0, left:0, bottom:0, right:0, justifyContent:'center', alignItems:'center'}}>
          ...
          > <Text style={{fontSize:15}}>Payment initializing</Text>
...
PayModalProgress.PropTypes = {
  isVisible: PropTypes.bool.isRequired,
  onClose: PropTypes.func
};
PayModalProgress.defaultProps = {
  onClose: ()=>{},
  isVisible: false
}

export default PayModalProgress;
